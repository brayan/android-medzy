...
class AsyncLoadMedication private constructor(context: Context, medId: Long, callback: OnSuccessResult<Medicine>) : AsyncSuccess(context) {
    ...
    companion object {
        ...
        fun load(context: Context, medicineId: Long, callback: OnSuccessResult<Medicine>) {
